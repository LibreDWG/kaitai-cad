meta:
  id: dwg_ac1012
  title: AutoCAD r13 drawing (AC1012)
  application: AutoCAD
  file-extension:
    - dwg
  xref:
  ...
  endian: le
doc: |
  This is work in progress, and does not parse at all yet.
  TODO: bitcompressed numbers (BS, BL, BD), objects, new tables, sections, ...
seq:
  - id: header
    type: header
  - id: entities
...
#        type: block_flag3
  ...
  header:
    seq:
      - id: magic
        contents: AC1012
        # [0x41, 0x43, 0x31, 0x30, 0x31, 0x32]
        doc: 0x0000-0x0005, $ACADVER/1
      - id: zeros
        size: 6
      - id: zero_one_or_three
        type: s1
      - id: thumbnail_address
        type: s4
      - id: dwg_version
        type: s1
        # contents: 0x14
      ...
      - id: data
        type:
          ...
          cases:
            ...
            'entities::block': entity_block
            'entities::endblk': entity_endblk
            'entities::seqend': entity_seqend
            'entities::insert' : entity_insert
            'entities::minsert' : entity_minsert
            'entities::circle': entity_circle
            'entities::face3d': entity_face3d
            'entities::line': entity_line
            'entities::point': entity_point
            'entities::polyline_2d': entity_polyline_2d
            'entities::polyline_3d': entity_polyline_3d
            'entities::shape': entity_shape
            'entities::solid': entity_solid
            'entities::text': entity_text
            'entities::trace': entity_trace
            'entities::vertex_2d': entity_vertex_2d
            'entities::vertex_3d': entity_vertex_3d
            'entities::vertex_mesh': entity_vertex_mesh
            'entities::vertex_pface': entity_vertex_pface
            'entities::vertex_pface_pface': entity_vertex_pface_pface
            'entities::dimension_ordinate': entity_dimension_ordinate
            'entities::dimension_linear': entity_dimension_linear
            'entities::dimension_aligned': entity_dimension_aligned
            'entities::dimension_ang3pt': entity_dimension_ang3pt
            'entities::dimension_ang2ln': entity_dimension_ang2ln
            'entities::dimension_radius': entity_dimension_radius
            'entities::dimension_diameter': entity_dimension_diameter
            'entities::polyline_pface': entity_polyline_pface
            'entities::polyline_mesh': entity_polyline_mesh
            'entities::viewport': entity_viewport
            'entities::ellipse': entity_ellipse
            'entities::spline': entity_spline
            'entities::region': entity_region
            'entities::solid3d': entity_solid3d
            'entities::body': entity_body
            'entities::ray': entity_ray
            'entities::xline': entity_xline
            'entities::dictionary': object_dictionary
            'entities::oleframe': entity_oleframe
            'entities::mtext': entity_mtext
            'entities::leader': entity_leader
            'entities::tolerance': entity_tolerance
            'entities::mline': entity_mline
            'entities::block_control': object_block_control
            'entities::block_header': object_block_header
            'entities::layer_control': object_layer_control
            'entities::layer': object_layer
            'entities::style_control': object_style_control
            'entities::style': object_style
            'entities::ltype_control': object_ltype_control
            'entities::ltype': object_ltype
            'entities::view_control': object_view_control
            'entities::view': object_view
            'entities::ucs_control': object_ucs_control
            'entities::ucs': object_ucs
            'entities::vport_control': object_vport_control
            'entities::vport': object_vport
            'entities::appid_control': object_appid_control
            'entities::appid': object_appid
            'entities::dimstyle_control': object_dimstyle_control
            'entities::dimstyle': object_dimstyle
            'entities::vx_control': object_vx_control
            'entities::vx_table_record': object_vx_table_record
            'entities::group': object_group
            'entities::mlinestyle': object_mlinestyle
            'entities::ole2frame': entity_ole2frame
            'entities::dummy': object_dummy
            'entities::long_transaction': object_long_transaction
            'entities::lwpolyline': entity_lwpolyline
            'entities::hatch': entity_hatch
            'entities::xrecord': object_xrecord
            'entities::placeholder': object_placeholder
            'entities::vba_project': object_vba_project
            'entities::layout': object_layout
            'entities::proxy_entity': entity_proxy
            'entities::proxy_object': object_proxy
            _: entity_tmp
  entity_mode:
    seq:
      - id: entity_mode128
...
enums:
  entities:
    ...
    7: insert
    8: minsert
    # NOT_USED 9: trace r10-r11 only
    10: vertex_2d
    11: vertex_3d
    12: vertex_mesh
    13: vertex_pface
    14: vertex_pface_pface
    15: polyline_2d
    16: polyline_3d
    17: arc
    18: circle
    19: line
    20: dimension_ordinate
    21: dimension_linear
    22: dimension_aligned
    23: dimension_ang3pt
    24: dimension_ang2ln
    25: dimension_radius
    26: dimension_diameter
    0x1b: point
    0x1c: face3d
    0x1d: polyline_pface
    0x1e: polyline_mesh
